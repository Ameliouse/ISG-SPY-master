...
public class ParamCompetenceSystem : FSystem
{
	...
	// Familles
	private Family f_competencies = FamilyManager.getFamily(new AllOfComponents(typeof(Competency))); // Les comp�tences
	...
	public GameObject compatibleLevelsPanel; // Le panneau permettant de g�rer les niveaux compatibles
	public GameObject competenciesPanel; // Le panneau permettant de g�rer la s�lection des comp�tences
	public GameObject levelCompatiblePrefab; // Le pr�fab d'un bouton d'un niveau compatible
	...
	public GameObject contentScenario; // Le panneau contenant les niveaux s�lectionn�s pour le sc�nario
